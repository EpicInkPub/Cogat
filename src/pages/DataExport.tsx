          ...
          <div className="grid md:grid-cols-3 gap-4 mb-8">
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-sm text-muted-foreground mt-1">Package orders submitted</p>
              </CardContent>
            </Card>
            <Card>
              <CardHeader className="pb-3">
              ...
              <CardContent>
                ...
                <p className="text-sm text-muted-foreground mt-1">Email addresses collected</p>
              </CardContent>
            </Card>
            <Card>
              <CardHeader className="pb-3">
              ...
              <CardContent>
                ...
                <p className="text-sm text-muted-foreground mt-1">User interactions tracked</p>
              </CardContent>
            </Card>
          </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardTitle>Lead Data Export</CardTitle>
                    <CardDescription>Export all captured lead information and form submissions</CardDescription>
                  </CardHeader>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Export all tracking events and user behavior data</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-3">
