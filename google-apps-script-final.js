...
const SPREADSHEET_ID = "1spg_4-vWPKdTZOUFNLTPibxvA-BYcrQaPLDIkbe37bM";
...
function doPost(e) {
  ...
  try {
    ...
    // Specific fields for analytics_event (CLICKS, INPUTS, SCROLL, etc.)
    else if (requestData.type === "analytics_event") {
      console.log('=== PROCESSING ANALYTICS EVENT ===');
      console.log('Event name:', requestData.data.eventName);
      console.log('Event properties:', JSON.stringify(requestData.data.properties));
